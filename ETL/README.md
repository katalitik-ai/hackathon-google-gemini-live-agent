...
A pipeline for **scraping, downloading, OCR processing, and ingesting** regulations from the Bank Indonesia website:

https://www.bi.go.id/id/publikasi/peraturan

The extracted data is stored in **Elasticsearch** to enable search and analysis.
...
- The pipeline supports **incremental ingestion**, so documents that already exist in Elasticsearch will be skipped.
